...
>>>>>>> 442de497daa5a0b47a10a4331bfce8c2165b293c
	}
...
<<<<<<< HEAD
				...
				log.setMensagem("O usu�rio"+this.usuario.getNome()+" entrou no sistema");
				log.setUsuario(user);
...
>>>>>>> 442de497daa5a0b47a10a4331bfce8c2165b293c
	...
	public String loginAnonimo(){
		...
		this.pessoa.setNome("Usu�rio An�nimo");
...
>>>>>>> 442de497daa5a0b47a10a4331bfce8c2165b293c
			...
			msg.setMensagem("Prezado(a) "+this.usuario.getPessoa().getNome()+", \n\n" +
					...
					"\nImportante:\n\n" +
<<<<<<< HEAD
					"\t1. Ao informar o login e senha, por favor, verifique se n�o tem espa�os em branco.\n" +
=======
